...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Hotel Ratna Forever, Nitte" },
      {
        name: "description",
        content: "Rooms, coastal dining and a banquet hall in Nitte, Karkala Taluk, Karnataka.",
      },
      { name: "author", content: "Hotel Ratna Forever" },
      { property: "og:site_name", content: "Hotel Ratna Forever" },
